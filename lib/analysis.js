...
async function forecastHypoRisk() {
  ...
  return {
    ...
    // Drives the Track tab's calibration prompt: until this reaches 3, the projection above is
    // trend-only - it isn't converting insulin or carbs into a glucose effect at all.
